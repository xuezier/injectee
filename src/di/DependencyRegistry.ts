import { Klass, Component, Reflection } from "../core";
import { DIException } from "./error";
...
export class DependencyRegistry {
    ...
    public static registerComponentPropertyHandler(klass: Klass) {
    ...
    public static registerHandler(target: any, key: string, index?: number) {
      ...
      if (typeof index !== 'undefined') {
        ...
        component.propertyHandlers.set(key, () => this.get(klass));
      }
    }
